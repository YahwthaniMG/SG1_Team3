...
def analyze_results(metrics_list: List[Dict], min_Production, max_production) -> Dict:
    ...
    aggregated = {
        ...
        "time_metrics": {"avg_production_time": [], "avg_fixing_time": [], "supplier_occupancy": []},
    }
    ...
    for metrics in metrics_list:
        ...
        for i in range(6):
            ...
            aggregated["station_metrics"]["wait_times"][i].append(metrics["station_metrics"]["wait_times"][i])
        ...
        aggregated["time_metrics"]["supplier_occupancy"].append(metrics["time_metrics"]["supplier_occupancy"])
    ...
    results = {
        ...
        "station_metrics": {
            ...
            "avg_wait_times": [np.mean(times) for times in aggregated["station_metrics"]["wait_times"]],
            "avg_downtimes": [np.mean(times) for times in aggregated["station_metrics"]["downtimes"]],
        },
        "time_metrics": {
...
if __name__ == "__main__":
    ...
    print(f"Average Fixing Time: {results['time_metrics']['avg_fixing_time']:.2f} units")
    print(f"Average Supplier Occupancy: {results['time_metrics']['avg_supplier_occupancy']:.2%}")
