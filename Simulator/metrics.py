    ...
    def get_metrics(self, total_time: float) -> Dict:
        ...
        return {
            "production": {
                ...
                "faulty_rate": (
                    self.faulty_products / (self.production_count + self.faulty_products)
            ...
            "station_metrics": {
                ...
                "wait_times": [
                    wait / self.production_count if self.production_count > 0 else 0 for wait in self.station_wait_times
                ],
