...
def save_simulation_results_to_graph(metrics, folder="./Results"):
    ...
    ax1.bar(stations, np.array(occupancy_rates) * 100, color="blue", alpha=0.6, label="Occupancy Rate")
    ax1.tick_params(axis="y", labelcolor="blue")

    ax2 = ax1.twinx()
    ax2.set_ylabel("Downtime (units)", color="red")
    ax2.plot(stations, downtimes, color="red", marker="o", linestyle="dashed", label="Downtime")
